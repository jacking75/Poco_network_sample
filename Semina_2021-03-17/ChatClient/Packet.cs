...
namespace csharp_test_client
{
    ...
    public class RoomChatNtfPacket
    {
        ...
        public bool FromBytes(byte[] bodyData)
        {
            ...
            Buffer.BlockCopy(bodyData, 0, userID, 0, PacketDef.MAX_USER_ID_BYTE_LENGTH);

            var msg = new byte[PacketDef.MAX_CHAT_MSG_SIZE];
            Buffer.BlockCopy(bodyData, PacketDef.MAX_USER_ID_BYTE_LENGTH, msg, 0, PacketDef.MAX_CHAT_MSG_SIZE);
